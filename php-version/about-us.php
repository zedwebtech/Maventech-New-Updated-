...
$features = [
    ['bi-award-fill',       'warning', 'Independent Reseller Since 2024', 'Registered as Maventech LLC (Company Registration Number: 202463711253, filed 9/3/2024) — a fully-compliant U.S. business focused solely on surplus &amp; pre-licensed software from vetted clearing houses.'],
      ...
      <div class="col-lg-8">
        <div class="card p-4">
          <div class="row g-3 small company-info-grid">
            ...
            <?php if ($brandRegNumber): ?><div class="col-sm-6 d-flex align-items-start gap-2" data-testid="about-reg-file-no"><i class="bi bi-patch-check text-primary mt-1"></i><div><div class="text-secondary text-uppercase" style="font-size:.65rem;letter-spacing:.06em;">Company Registration Number</div><div class="fw-semibold"><?= esc($brandRegNumber) ?></div></div></div><?php endif; ?>
