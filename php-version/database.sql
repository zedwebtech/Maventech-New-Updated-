-- ===========================================================================
-- Maventech Software — Admin Panel database schema + seed data
-- ===========================================================================
...
INSERT IGNORE INTO `email_outbox` (`id`, `recipient`, `subject`, `html`, `status`, `note`, `order_id`, `created_at`, `delivered_at`, `opened_at`, `opened_count`, `tracking_token`, `provider_id`, `clicked_at`, `click_count`, `template_code`, `attachments_json`, `retry_count`, `max_retries`, `next_retry_at`, `error_details`, `last_error`, `message_id`, `bounced_at`, `priority`) VALUES (22,'invalid-email@unknowndomain.zzz','Your Microsoft product key — Order #MVT-DEMO-099','<p>Sample failed delivery (bounced).</p><img src=\"https://demo-viewer-3.preview.emergentagent.com/track-open.php?t=c627cabbbfb93ae781fa16a82ab5b16d\" width=\"1\" height=\"1\" alt=\"\">','sent',NULL,NULL,'2026-06-12 13:23:37','2026-06-12 13:23:37',NULL,0,'c627cabbbfb93ae781fa16a82ab5b16d',NULL,NULL,0,'order_delivery',NULL,0,3,NULL,NULL,NULL,NULL,NULL,5);
...
INSERT IGNORE INTO `pages` (`slug`, `title`, `updated`, `content`) VALUES ('my-account','My Account',NULL,'<p class=\"lead\">Manage your orders, view your license keys, update billing details, and access support tickets. Sign in to your Maventech Software account for instant access to your purchase history and downloadable software.</p>');
...
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('main_url','https://demo-viewer-3.preview.emergentagent.com','2026-06-23 10:35:12');
...
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('site_domain_url','https://demo-viewer-3.preview.emergentagent.com','2026-06-23 10:35:12');
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('staff_schema_v1','1','2026-06-23 10:41:06');
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('statement_name_card','MAVENTECH SOFTWARE','2026-06-12 10:10:17');
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('statement_name_paypal','MAVENTECH SOFTWARE LLC','2026-06-12 10:10:17');
