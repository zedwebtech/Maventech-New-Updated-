...
INSERT IGNORE INTO `email_outbox` (`id`, `recipient`, `subject`, `html`, `status`, `note`, `order_id`, `created_at`, `delivered_at`, `opened_at`, `opened_count`, `tracking_token`, `provider_id`, `clicked_at`, `click_count`, `template_code`, `attachments_json`, `retry_count`, `max_retries`, `next_retry_at`, `error_details`, `last_error`, `message_id`, `bounced_at`, `priority`) VALUES (22,'invalid-email@unknowndomain.zzz','Your Microsoft product key — Order #MVT-DEMO-099','<p>Sample failed delivery (bounced).</p><img src=\"https://site-viewer-32.preview.emergentagent.com/track-open.php?t=c627cabbbfb93ae781fa16a82ab5b16d\" width=\"1\" height=\"1\" alt=\"\">','sent',NULL,NULL,'2026-06-12 13:23:37','2026-06-12 13:23:37',NULL,0,'c627cabbbfb93ae781fa16a82ab5b16d',NULL,NULL,0,'order_delivery',NULL,0,3,NULL,NULL,NULL,NULL,NULL,5);
...
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('main_url','https://site-viewer-32.preview.emergentagent.com','2026-06-23 10:35:12');
...
INSERT IGNORE INTO `settings` (`k`, `v`, `updated_at`) VALUES ('site_domain_url','https://site-viewer-32.preview.emergentagent.com','2026-06-23 10:35:12');
