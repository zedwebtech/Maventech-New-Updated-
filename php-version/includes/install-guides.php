    ...
    'office_mac' => [
        ...
        'steps' => [
            ['title' => 'Sign in and redeem your key',
             'html'  => 'Office for Mac is downloaded after redeeming your key. Click <strong>Activate / Sign in</strong> below to open the official setup page, sign in with (or create) a free Microsoft account, and enter the 25-character key from your order email to link the licence to your account.',
             'img'   => null],
            ['title' => 'Download the installer package',
             'html'  => 'After redeeming, download the Office for Mac installer (a <em>.pkg</em> file). Open your <em>Downloads</em> folder and double-click it to begin.',
             'img'   => 'mac/mac-1.jpg'],
            ['title' => 'Start the installer',
             'html'  => 'The Microsoft Office installer opens. Click <strong>Continue</strong> on the introduction screen.',
             'img'   => 'mac/mac-2.png'],
            ['title' => 'Read the software licence',
             'html'  => 'Review the licence agreement and click <strong>Continue</strong>.',
             'img'   => 'mac/mac-3.png'],
            ['title' => 'Agree to the terms',
             'html'  => 'Click <strong>Agree</strong> to accept the licence and continue.',
             'img'   => 'mac/mac-4.png'],
            ['title' => 'Choose where to install and click Install',
             'html'  => 'Confirm the installation location (the default is recommended) and click <strong>Install</strong>.',
             'img'   => 'mac/mac-6.png'],
            ['title' => 'Authenticate to allow the install',
             'html'  => 'Enter your Mac login password (or use Touch ID) so macOS can install the software.',
             'img'   => 'mac/mac-7.png'],
            ['title' => 'Installation complete',
             'html'  => 'When you see the success screen, click <strong>Close</strong>. Open <strong>Word</strong> (or any Office app) from Launchpad and sign in with the same Microsoft account &mdash; your apps are now activated.',
             'img'   => 'mac/mac-8.png'],
        ],
