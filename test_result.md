  ...
  - task: "Bug fix — policy pages showed a hardcoded phone (+1 888-632-9902) instead of the live Company Info number"
    ...
    status_history:
        ...
        -comment: |
          ...
          - curl -sk -i https://defect-prevention.preview.emergentagent.com/ returns HTTP/2 200 (NOT 301) ✅
...
#====================================================================================================
    ...
    -message: |
      ...
      Focus ONLY on the new installation guide feature. Test at https://defect-prevention.preview.emergentagent.com
  ...
  - task: "Google Ads/Merchant Compliance Overhaul - Remove discount badges, verify no ProAssist upsell, compliance spot-checks"
    ...
    status_history:
        ...
        -comment: |
          ...
          Tested 10 critical compliance items on preview URL: https://defect-prevention.preview.emergentagent.com
...
agent_communication:
    ...
    -message: |
      ...
      Tested all 10 compliance items from the review request on preview URL: https://defect-prevention.preview.emergentagent.com
    ...
    -message: |
      ...
      PLEASE VERIFY at http://localhost:3000/ (preview) and via curl with faked host headers (we can't test their real Apache, but we can validate the intent of router.php + inspect .htaccess statically):
        ...
        (a) Preview host unchanged: GET https://defect-prevention.preview.emergentagent.com/ → HTTP 200 (no redirect). Also confirm curl -si -H "Host: 58485f15-d8bc-415a-9027-8cd21a31434f.preview.emergentagent.com" http://127.0.0.1:3000/ → 200.
      ...
      Please verify at https://defect-prevention.preview.emergentagent.com/ (and via internal curl at http://localhost:3000/):
    ...
    -message: |
      ...
      SECTION 1 — External preview URL (through Cloudflare): ✅ PASS
      - curl -sk -i https://defect-prevention.preview.emergentagent.com/ returns HTTP/2 200 (NOT 301 to www.*)
      - x-powered-by: PHP/8.2.31 header present
  ...
  - task: "Admin login with Admin@UC2026! password"
    ...
    status_history:
        ...
        -comment: |
          ...
          - Navigated to https://defect-prevention.preview.emergentagent.com/login.php
...
agent_communication:
    -agent: "main"
    -message: |
      Please verify 3 things on the Maventech PHP storefront preview URL (https://defect-prevention.preview.emergentagent.com):
  ...
  - task: "Bug fix — Mobile currency dropdown clipping on iPhone 14 viewport (390x844)"
    ...
    status_history:
        ...
        -comment: |
          ...
          Tested on preview URL: https://defect-prevention.preview.emergentagent.com
  ...
  - task: "Protection Hub — Centered card layout for all 4 plans (Quick Fix, Starter Care, Pro Shield, Lifetime Elite)"
    ...
    status_history:
        ...
        -comment: |
          ...
          Tested on preview URL: https://defect-prevention.preview.emergentagent.com/protection-hub.php
  ...
  - task: "Protection Hub — Checkout thumbnail matches plan icon (Quick Fix plan shows quick-fix.svg, not generic subscription icon)"
    ...
    status_history:
        ...
        -comment: |
          ...
          Tested on preview URL: https://defect-prevention.preview.emergentagent.com/checkout.php
          Viewport: 1920x900 (Desktop)
  ...
  - task: "Merchant Center feed — Protection Hub plans included with correct metadata (plan IDs, prices, images, category 449)"
    ...
    status_history:
        ...
        -comment: |
          ...
          Tested on preview URL: https://defect-prevention.preview.emergentagent.com/merchant-feed.php
    ...
    -message: |
      ...
      Tested TWO specific fixes on Maventech PHP storefront preview URL: https://defect-prevention.preview.emergentagent.com
